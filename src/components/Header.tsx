            ...
            <header className="py-10 px-20 border-b-[0.5px] border-gray-400/25 bg-gradient-to-r from-[--color-darker] to-[--color-dark]">
                <nav className="flex justify-between items-center px-40">
                    ...
                    <ul className="flex space-x-8 capitalize text-white font-medium">
                        <li><a href="/" className="hover:underline underline-offset-8 transition duration-300 text-grey-400">Home</a></li>
                        <li><a href="/about" className="hover:underline underline-offset-8 transition duration-300 text-grey-400">About</a></li>
                        <li><a href="/blog" className="hover:underline underline-offset-8 transition duration-300 text-grey-400">Blog</a></li>
                        <li><a href="/gallery" className="hover:underline underline-offset-8 transition duration-300 text-grey-400">Gallery</a></li>
                        <li><a href="/contact" className="hover:underline underline-offset-8 transition duration-300 text-grey-400">Contact</a></li>
                    </ul>
