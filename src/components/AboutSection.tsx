        ...
        <section className="px-52">
            <div className="flex flex-col">
                <div className='flex flex-row py-32'>
                    {/* Header Section */}
                    <div className="flex-1 basis-3/12 mt-3">
                        <h3 className="text-[--color-blue] uppercase tracking-wide font-semibold"><span className="text-[--color-blue] font-semibold">— </span>
                            ABOUT</h3>
                    </div>
                    {/* Introduction Text */}
                    <div className="px-4">
                        <h2 className="text-4xl font-family mb-6 font-semibold">
                ...
                <div className="flex gap-x-16">
                    ...
                    <div className="w-[55%] flex flex-col gap-8">
                        ...
                        {/* Read More Link */}
                        <a href="#" className="text-[--color-blue] hover:opacity-80 transition duration-300 flex items-center gap-2 mt-4 underline underline-offset-4 font-semibold">
                            READ THE FULL STORY →
                        </a>
